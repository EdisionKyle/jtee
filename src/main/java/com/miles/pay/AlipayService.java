...
public class AlipayService {
	 ...
	 * @param paymethod
	 *            默认支付方式，四个值可选：bankPay(网银); cartoon(卡通); directPay(余额);
	 *            CASH(网点支付)
	 * @param defaultbank
	 *            默认网银代号，代号列表见club.alipay.com/read.php?tid=8681379
	 * @param encrypt_key
	 *            防钓鱼时间戳
	...
	public static String BuildForm(String partner, String seller_email,
			...
			String paymethod, String defaultbank, String anti_phishing_key,
			String exter_invoke_ip, String extra_common_param,
			String buyer_email, String royalty_type, String royalty_parameters,
			String input_charset, String key, String sign_type, String it_b_pay) {
		...
		Map<String, Object> sParaNew = AlipayFunction.ParaFilter(sPara); // 除去数组中的空值和签名参数
