...
public class MessageFormatTest {
	...
	public static void main(String[] args) {
		...
		Object[] params = { "Asa", "23", "QiLiHe lz.China" };
		...
		String msg2 = MessageFormat
				.format("{0,date,short} --- {1,time,medium} --- {2,date,yyyy-MM-dd HH:mm:ss}",
						params2);
		...
		String msg3 = MessageFormat.format(
				"{0,number,percent}  --- {1,number,percent}", params3);
		System.out.println(msg3);
		// 45% --- 123,456%

		// 4
		Object[] params4 = new Object[] { new Double(123.45),
				new Double(1234.56) };
		String msg4 = MessageFormat.format(
				"{0,number,currency} --- {1,number,currency}", params4);
		...
		String msg5 = MessageFormat.format(
				"{0,number,#} a''s and {1,number,#} b''s", params5);
