...
public class BankCountLock {
	public static void main(String[] args) {
		// 创建并发访问的账户
		BankCount myCount = new BankCount("95599200901215522", 10000);
		// 创建一个锁对象
...
class User implements Runnable {
	...
	private BankCount myCount; // 所要操作的账户
	private int iocash; // 操作的金额，当然有正负之分了
	private Lock myLock; // 执行操作所需的锁对象

	User(String name, BankCount myCount, int iocash, Lock myLock) {
		this.name = name;
