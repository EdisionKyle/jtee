...
public class StringBufferClearTest {
	static String a;
	...
	public static void main(String[] args) {
		...
		System.out.println("重新生成对象执行时间=" + (System.currentTimeMillis() - time));
		...
		System.out.println("delete(0, sb.length())执行时间=" + (System.currentTimeMillis() - time));
		...
		System.out.println("setLength(0)执行时间=" + (System.currentTimeMillis() - time));
